...
class ProductsPage extends ConsumerWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            productsAsync.when(
              ...
              loading: () => const SizedBox(height: 100, child: Center(child: CircularProgressIndicator(color: Color(0xFF6366F1)))),
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: productsAsync.when(
          ...
          ? const Center(child: Text("Henüz ürün bulunmuyor.", style: TextStyle(color: Colors.white24)))
              ...
              child: DataTable(
                ...
                rows: products.map((p) => DataRow(
                  cells: [
                    ...
                    // BURASI DÜZELTİLDİ: num tipi double'a zorlandı ve null güvenliği eklendi
  ...
  // Fonksiyon num kabul edecek şekilde esnetildi, böylece int veya double gelse de hata vermez
  Widget _statusBadge(num stockValue) {
    final double stock = stockValue.toDouble();
    ...
    return Container(
      ...
      child: Text(
        label, 
        style: TextStyle(color: color.withOpacity(0.9), fontSize: 11, fontWeight: FontWeight.bold)
      ),
    );
  }
}